...
export default class Splash extends Component {
  ...
  render() {
    ...
    !this.state.rareRight
      ? (tailLightRight = require('../../../images/7pinHeavy/rare_r_w_0.png'))
      : (tailLightRight = require('../../../images/7pinHeavy/rare_r_w_0Active.png'));
    let tailLightLeft;
    !this.state.rareLeft
      ? (tailLightLeft = require('../../../images/7pinHeavy/rare_l_w_0.png'))
      : (tailLightLeft = require('../../../images/7pinHeavy/rare_l_w_0Active.png'));
    let revereLight;
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            <View
              ...
              <View style={styles.imageBox}>
                <Text style={styles.imageText}>7-PIN HEAVY-DUTY</Text>
                <Image
                  resizeMode="contain"
                  style={styles.image1}
