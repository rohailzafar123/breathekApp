      ...
      <View style={styles.container}>
        ...
        <View style={styles.uperBody}>
          <Image
            ...
            source={require('../../../images/6pinSmall/barone.png')}
          />
          ...
          <Image
            resizeMode="contain"
            style={styles.wifi}
            source={require('../../../images/6pinSmall/action_rssi.png')}
          />
        </View>
          ...
          <View style={{
            ...
            <Text style={styles.imageText}>Left Indicator</Text>
              <Image
                resizeMode="contain"
                style={styles.image3}
                source={require('../../../images/6pinSmall/left_b_0.png')}
              />
            </View>
            <View style={styles.imageBox}>
            <Text style={styles.imageText}>Right Indicator</Text>
              <Image
                resizeMode="contain"
                style={styles.image3}
                source={require('../../../images/6pinSmall/right_w_0.png')}
              />
            </View>
            <View style={styles.imageBox}>
            <Text style={styles.imageText}>Tail light</Text>
              <Image
                resizeMode="contain"
                style={styles.image3}
                source={require('../../../images/6pinSmall/rare_both_w_0.png')}
              />
            </View>
            <View style={styles.imageBox}>
            <Text style={styles.imageText}>Stop light</Text>
              <Image
                resizeMode="contain"
                style={styles.image3}
                source={require('../../../images/6pinSmall/newstop.png')}
              />
            </View>
          </View>
        </ScrollView>
